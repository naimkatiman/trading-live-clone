  ...
  return (
    <footer className="bg-gray-900 dark:bg-gray-950 text-white py-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex flex-wrap justify-between mb-8">
          <div className="w-full md:w-auto mb-6 md:mb-0">
            <div className="flex items-center space-x-2 mb-4">
              <select
                className="bg-gray-800 dark:bg-gray-900 border border-gray-700 rounded text-sm p-1"
          ...
          <div className="w-full md:w-auto flex flex-col md:flex-row gap-4">
            <a href="#" className="inline-flex items-center justify-center rounded-md bg-white dark:bg-gray-800 px-4 py-2 text-sm font-medium text-gray-900 dark:text-white">
        ...
        <Separator className="bg-gray-800 dark:bg-gray-700 mb-4" />
