...
export function Sidebar() {
  return (
    <div className="w-56 border-r bg-card h-full">
      <div className="py-4 px-2 flex flex-col gap-1 h-full">
        ...
        <div className="mt-auto pt-4 border-t">
          <nav className="space-y-0.5 text-sm">
            ...
            <Link href="/agreement" className="block px-3 py-2 text-muted-foreground hover:text-primary">
              User Agreement
            </Link>
            <Link href="/privacy" className="block px-3 py-2 text-muted-foreground hover:text-primary">
              Privacy Policy
            </Link>
            <Link href="/disclosure" className="block px-3 py-2 text-muted-foreground hover:text-primary">
              Risk Disclosure
            </Link>
            <Link href="/partner" className="block px-3 py-2 text-muted-foreground hover:text-primary">
